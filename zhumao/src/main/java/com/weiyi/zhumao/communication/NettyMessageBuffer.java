...
import com.weiyi.zhumao.convert.Transform;
 ...
 * ByteBuf, instead it has a method {@link #getNativeBuffer()} which can
 * be used to retrieve the buffer and then call the appropriate method. For
 * writing to the buffer, this class uses {@link DynamicByteBuf}
 * implementation.
 * 

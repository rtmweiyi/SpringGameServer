...
import com.weiyi.zhumao.event.impl.ChangeAttributeEvent;
import com.weiyi.zhumao.event.impl.DefaultConnectEvent;
import com.weiyi.zhumao.event.impl.DefaultEvent;
import com.weiyi.zhumao.event.impl.DefaultEventContext;
...
public class Events
{
	...
	public static final byte CHANGE_CAR = 0x30;
	public static final byte CHANGE_CAR_SUCCESS = 0x31;
	public static final byte CHANGE_CAR_FAILURE = 0x32;

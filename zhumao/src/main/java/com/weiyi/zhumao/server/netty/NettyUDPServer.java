 ...
 * cannot be modified refer to
 * <a href="http://www.jboss.org/netty/community.html#nabble-f685700">nabble
 * post</a>
 * 
...
public class NettyUDPServer extends AbstractNettyServer {
    ...
    public String toString() {
        return "NettyUDPServer [socketAddress=" + nettyConfig.getSocketAddress() + ", portNumber="
